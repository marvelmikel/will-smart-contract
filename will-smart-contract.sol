...
contract Will{
    ...
    // create modifier so the  only person who can only call the contract is the owner
    modifier onlyOwner{
    ...
    //create modifier so that we only allocate  funds if  freinds gramps deceased
    ...
    function setInheritance(address payable wallet, uint amount) public onlyOwner{
        // to add walet to the family wallet . push
